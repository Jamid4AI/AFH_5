...
app.post('/register', (req, res) => {
  ...
  console.log('Parsed fields:', { name: !!name, email: !!email, password: !!password, homeName: !!homeName });
  if (!name || !email || !password || !homeName) {
    console.log('Missing fields - redirecting with error');
    return res.redirect('/register?error=All fields required. Please try again.');
  }
